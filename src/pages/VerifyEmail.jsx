...
<>
<div className="container otp-container my-5">
    <div className="row shadow rounded overflow-hidden">
      ...
      <div className="col-md-6 otp-section pt-5 d-flex flex-column justify-content-center align-items-center bg-light" id="OTPBOX">
        <h2 className="mb-3 fw-bold text-center">Enter 6-Digit OTP</h2>
        ...
        <div className='d-flex  gap-2 justify-content-between h-100 w-100'  >
                <p>back to login</p>
                 <p>Resend it</p>
           </div>
      ...
      <div className="col-md-6 d-none d-md-block p-0 position-relative">
        <img src={image} alt="Fresh Veggies" className="img w-100 h-100" style={{ objectFit: 'cover' }} />
